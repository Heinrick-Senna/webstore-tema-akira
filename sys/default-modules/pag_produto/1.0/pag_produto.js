...
$(document).ready(function () {
    ...
    try {
        //Cria a seleÃƒÂ§ÃƒÂ£o de variaÃƒÂ§ÃƒÂ£o em duas cores
    ...
    try {
        ...
        if (obj.disponivel == true) {
            ...
            if (obj.precos != null && obj.precos != undefined && obj.precos.preco != 0 && (!cfg['preco_apos_login'] == true || cliente || cfg['preco_apos_login'] == undefined || cfg['preco_apos_login'] == null)) {
                ...
                if (PROMOCAO != 0) {
                    ...
                    if (VEZES > 1 || 1 == 1) {
                        // valores[0] = preÃƒÂ§o de venda do produto
                        // valores[1] = desconto
                        // valores[2] = quantidade m&aacute;xima de parcelas (vezes) aceita pela loja
                        // valores[3] = parcela mÃƒÂ­nima aceita pela loja
        ...
        if (obj.descricoes != null && obj.descricoes != undefined && obj.descricoes.length > 0) {
            ...
            if (obj.video) {
                ...
                let videoUrl = obj.video;
                videoUrl = videoUrl.replace("https://www.youtube.com/embed/", "").replace("https://youtu.be/", "").replace("https://www.youtube.com/watch?v=", "").replace("youtu.be/", "").replace("https://", "");
                ...
                TABCONTENT += '<div style="position:relative;height:0;padding-bottom:56.21%"><iframe src="https://www.youtube.com/embed/' + videoUrl + '?ecver=2" style="position:absolute;width:100%;height:100%;left:0" width="641" height="360" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>';
                TABCONTENT += '</div>';
                ...
                ACCORDION += '<div style="position:relative;height:0;padding-bottom:56.21%"><iframe src="https://www.youtube.com/embed/' + videoUrl + '?ecver=2" style="position:absolute;width:100%;height:100%;left:0" width="641" height="360" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>';
                ACCORDION += '</div></div></div>';
            }
            ACCORDION += '</div>';
        ...
        // funÃƒÂ§ÃƒÂ£o que gera a contagem regressiva
...
function PrecosProduto(PRECO, DESCONTO, PARCELAS, MIN, INICIA, JUROS) {
    ...
    // deve retornar preÃƒÂ§o ÃƒÂ  vista, parcelado sem juros e tabela de precos
}
