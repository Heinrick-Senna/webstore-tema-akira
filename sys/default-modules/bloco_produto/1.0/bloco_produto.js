function BlocoProduto(OBJ, TEMPLATE){
 ...
 FOTO += '<img src="/lojas/img/fotoindisponÃ­vel.jpg" alt="'+TITLE+'" class="img-responsive">';
 }
 FOTO += '</a>';
 if (OBJ.lancamento == true) {
 ADD += '<span class="prod-lancamento">LanÃ§amento</span>';
 }
 ...
 UMA = '<p class="prod-preco-uma"><a href="'+LINK+'" title="'+TITLE+'">R$'+UMA+' Ã  vista</a></p>';
 }else{
 ...
 PRECO += '<p class="produto-indisponivel"><a href="'+LINK+'" title="'+TITLE+'" class="tarja-indisponivel">Produto indisponÃ­vel</a></p>';
 CLASS += "preco-null";
 }
